...
class BookingScreen2 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _BookingScreenScreenState();
}
...
class _BookingScreenScreenState extends State<BookingScreen2> {
  ...
  @override
  void initState() {
    _organizations = Provider.of<doctor_search.DoctorFilterProvider>(
      context,
      listen: false,
    ).getOrganizationsApplied.isNotEmpty
        ? Provider.of<doctor_search.DoctorFilterProvider>(
            context,
            listen: false,
          ).getOrganizationsApplied
        : null;
    BlocProvider.of<DoctorAvailabilityBloc>(context).add(
      GetAvailability(
      ...
      body: SafeArea(
        child: MultiBlocListener(
          listeners: [
            ...
            BlocListener<more_availabilities.DoctorMoreAvailabilityBloc,
                more_availabilities.DoctorMoreAvailabilityState>(
              listener: (context, state) {
                if (state is more_availabilities.Failed) {
                  emitSnackBar(
                    ...
                    is more_availabilities.AvailabilitiesObtained) {
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        ListView.builder(
                                          ...
                                          itemCount:
                                              organizationsWithAvailabilites
                                                  .length,
                                          itemBuilder:
                                              _organizationAvailabilities,
                                          physics:
                                ...
                                children: [
                                  Flexible(
                                    child: Text(
                                      "${getDoctorPrefix(widget.doctor.gender!)} ${widget.doctor.givenName?.split(" ")[0]} ${widget.doctor.familyName?.split(" ")[0]}",
                                      style:
                                          boldoCardSubtitleTextStyle.copyWith(
                                ...
                                TableCalendar(
                                  ...
                                  onDaySelected:
                                    ...
                                    setState(() {
                                      ...
                                      BlocProvider.of<
                                                  more_availabilities
                                                  .DoctorMoreAvailabilityBloc>(
                                              context)
                                          .add(more_availabilities
                                              .GetAvailability(
                                        id: widget.doctor.id ?? '',
                                        ...
                                        organizations: [
                                          Organization(
                                              id: _selectedOrganization
                                                  ?.idOrganization,
                                              name: _selectedOrganization
                                                  ?.nameOrganization)
                                        ],
                                  ...
                                  selectedDayPredicate: (day) =>
                                      isSameDay(day, date),
                                  calendarFormat: _expandCalendar
                          ...
                          SliverFillRemaining(
                            ...
                            child:
                                BlocBuilder<
                                        ...
                                        .DoctorMoreAvailabilityBloc,
                                        more_availabilities
                                        .DoctorMoreAvailabilityState>(
                                    builder: (context, state) {
                              if (state is more_availabilities
                                  .AvailabilitiesObtained) {
                                return Wrap(
                                  alignment: WrapAlignment.center,
                                  spacing: 14,
                                  runSpacing: 14,
                                  children: [
                                    if (calendarOrganizationsWithAvailabilites
                                        .isNotEmpty)
                                      if (calendarOrganizationsWithAvailabilites
                                          .first.availabilities.isNotEmpty)
                                        for (NextAvailability? availability
                                            in calendarOrganizationsWithAvailabilites
                                                .first.availabilities
                                                .map((e) => e))
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                if (organizationsWithAvailabilites[index]
                    .availabilities
                    .isNotEmpty)
                  if (DateTime(
                          DateTime.parse(organizationsWithAvailabilites[index]
                                      .availabilities
                                      .first
                                      ?.availability ??
                    ...
                    Flexible(
                        child: Text(
                      "Disponible el ${DateFormat('dd/MM').format(DateTime.parse(organizationsWithAvailabilites[index].availabilities.first?.availability ?? DateTime.now().toString()))}",
                      style: boldoBodyLRegularTextStyle.copyWith(
                          color: ConstantsV2.activeText),
                    ))
              ],
          ...
          Container(
            ...
            child: Wrap(
              ...
              children: [
                Container(
                  child: organizationsWithAvailabilites[index]
                          .availabilities
                          .isNotEmpty
                      ? SingleChildScrollView(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          setState(() {
                            ...
                            BlocProvider.of<
                                    more_availabilities
                                    .DoctorMoreAvailabilityBloc>(context)
                                .add(more_availabilities.GetAvailability(
                              id: widget.doctor.id ?? '',
                              startDate: date.toUtc(),
                              endDate:
                              ...
                              organizations: [
                                Organization(
                                    id: _selectedOrganization?.idOrganization,
                                    name:
                                        _selectedOrganization?.nameOrganization)
                              ],
                              appointmentType: selectedType,
                            ));
                          });
  ...
  Widget _availabilityHourCard(int indexOrganization, int index) {
    bool _selected = _selectedBookingHour ==
        organizationsWithAvailabilites[indexOrganization].availabilities[index];
    String? appointmentType = organizationsWithAvailabilites[indexOrganization]
    ...
    return Container(
        ...
        child: GestureDetector(
          onTap: appointmentType?.contains(
                      selectedType == AppointmentType.Virtual ? "V" : "A") ??
                  false
              ? () {
                  setState(() {
                    _selectedBookingHour =
                        organizationsWithAvailabilites[indexOrganization]
                            .availabilities[index];
                    _selectedOrganization =
                        organizationsWithAvailabilites[indexOrganization];
                  });
          ...
          child: Container(
            decoration: ShapeDecoration(
              color: appointmentType?.contains(
                          selectedType == AppointmentType.Virtual
                              ? "V"
                              : "A") ??
                      false
                  ? _selected
                      ? ConstantsV2.orange
                      : ConstantsV2.secondaryLightAndClear
                  : ConstantsV2.gray,
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(100),
            ...
            child: Row(
              children: [
                Text(
                  "${DateFormat('HH:mm').format(DateTime.parse(organizationsWithAvailabilites[indexOrganization].availabilities[index]?.availability ?? DateTime.now().toString()))}",
  ...
  Future<void> handleBookingHour(
    ...
    NextAvailability _bookingHour =
        NextAvailability.fromJson(bookingHour.toJson());
    _bookingHour.appointmentType = selectedType == AppointmentType.InPerson
        ? "A"
        : selectedType == AppointmentType.Virtual
            ? "V"
            : "none";
  ...
  Widget _calendarAvailabilityHourCard(
      OrganizationWithAvailabilities? organization,
      ...
      child: Card(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Text(
                "${DateFormat('HH:mm').format(DateTime.parse(availability.availability ?? DateTime.now().toString()))}",
                style: boldoCorpMediumBlackTextStyle.copyWith(
                    color: appointmentType?.contains(
                                selectedType == AppointmentType.Virtual
                                    ? "V"
