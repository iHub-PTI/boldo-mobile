...
class _AttachFilesState extends State<AttachFiles> {
        ...
        child: BlocListener<NewStudyBloc, NewStudyState>(
          ...
          child: Column(
            ...
            children: [
              ...
              if (widget.newStudyBloc.files.isEmpty)
                Expanded(
                  child: Padding(
                    ...
                    BlocBuilder<NewStudyBloc, NewStudyState>(
                      ...
                      builder: (BuildContext context, state) {
                        ...
                        return ElevatedButton(
                          onPressed: widget.newStudyBloc.files.isNotEmpty &&
                                  !(state is Uploading)
                              ? () async {
  ...
  void getFromFiles() async {
    ...
    if (result != null) {
      widget.newStudyBloc
          .addFiles(newFiles: result!.files.map((e) => File(e.path!)).toList())
          .then((value) => setState(() {}));
    }
  }
  ...
  Widget _fileElement(BuildContext context, int index) {
    ...
    if (widget.newStudyBloc.files[index].value.isLeft()) {
      widget.newStudyBloc.files[index].value
          .leftMap((l) => _errorMessage = l.message);
    }
