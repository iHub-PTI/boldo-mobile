                        ...
                        Container(
                          ...
                          child: ClipOval(
                            child: SizedBox(
                              width: 54,
                              height: 54,
                              child: widget.studyOrder.doctor?.photoUrl == null
                                  ? SvgPicture.asset(
                                  widget.studyOrder.doctor!.gender == "female"
                                      ? 'assets/images/femaleDoctor.svg'
                                      : 'assets/images/maleDoctor.svg',
                                  fit: BoxFit.cover)
                                  : CachedNetworkImage(
                                fit: BoxFit.cover,
                                imageUrl: widget.studyOrder.doctor!.photoUrl??'',
        ...
        child: Row(
            children: [
                ...
                children: [
                  Card(
                    ...
                    child: Container(
                      ...
                      child: Text("${widget.studyOrder.serviceRequests?.length?? 0}"),
                    )
                  ),
                  Text(
                    "ordenes",
              ...
              Container(
                ...
                child: Row(
                  children: [
                    if(widget.studyOrder.serviceRequests!.any((element) => element.category == 'Laboratory'))
                      Container(
                        padding: const EdgeInsets.all(3),
                    ...
                    if(widget.studyOrder.serviceRequests!.any((element) => element.category == 'Diagnostic Imaging'))
                      Container(
                        padding: const EdgeInsets.all(3),
                        child: SvgPicture.asset(
                    ...
                    if(widget.studyOrder.serviceRequests!.any(
                        (element) {
