        ...
        children: [
          Padding(
            ...
            child: BackButtonLabel(
              labelText: 'Términos de servicio',
            ),
          ),
          Expanded(
                ...
                child: RichText(
                  text: TextSpan(
                    ...
                    children: const <TextSpan>[
                      ...
                      TextSpan(
                        text:
                            'CONDICIONES DE LOS SERVICIOS OFRECIDOS POR BOLDO \n\n',
                        style: TextStyle(fontWeight: FontWeight.normal),
                      ),
                      TextSpan(
                        text:
                            'Boldo provee los siguientes servicios a médicos: \n\n',
                        style: TextStyle(fontWeight: FontWeight.bold),
                      ),
                      TextSpan(
                        text: 'a)',
                      ...
                      TextSpan(
                        text:
                            'Boldo provee los siguientes servicios a farmacéuticos: \n\n',
                        style: TextStyle(fontWeight: FontWeight.bold),
                      ),
                      TextSpan(
                        text: 'a)',
                      ...
                      TextSpan(
                        text:
                            'Requisitos y responsabilidades de farmacéuticos: \n\n',
                        style: TextStyle(fontWeight: FontWeight.bold),
                      ),
                      TextSpan(
                        text: 'a)',
                      ...
                      TextSpan(
                        text:
                            'Boldo provee los siguientes servicios a pacientes: \n\n',
                        style: TextStyle(fontWeight: FontWeight.bold),
                      ),
                      TextSpan(
                        text: 'a)',
                      ...
                      TextSpan(
                        text:
                            'Requisitos y responsabilidades de pacientes: \n\n',
                        style: TextStyle(fontWeight: FontWeight.bold),
                      ),
                      TextSpan(
                        text: 'a)',
